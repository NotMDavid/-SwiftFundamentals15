...
class Fighter: Spaceship {
    ...
    func Fire() {
        if remainingFirePower > 0 {
            ...
            print("Fired Shot! \(remainingFirePower) shots left")
        }
        else {
            print("No Ammo")
        }
...
// print(falcon.weapons)
// It gives a error because falcon does NOT have a weapons section. Only the destroyer has it.
