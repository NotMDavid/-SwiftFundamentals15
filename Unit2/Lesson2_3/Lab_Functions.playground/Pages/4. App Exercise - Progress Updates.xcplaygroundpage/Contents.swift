...
progressUpdate(steps: 2491, goal: 8000)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    ...
    let requiredPace = totalDistance / currentTime
    
    if pace >= requiredPace {
        print("Keep it up")
    }
    else {
...
pacing(currentDistance: 293, totalDistance: 32, currentTime: 432, goalTime: 500)
/*:
