 ...
 */
let walkChallenge = ["Run 12,000 steps, Walk 15,000 steps"]
let mileChallenge = ["Run 3 miles, Run 5 miles"]
...
let challenges = [walkChallenge, mileChallenge]

if challenges.count > 1 {
    print(challenges[1].first ?? "No challenge available")
}

//:  All of the challenges will reset at the end of the month. Use the `removeAll` to remove everything from `challenges`. Print `challenges`.
var currentChallenges = challenges
currentChallenges.removeAll()
print(currentChallenges)
...
if committedChallenges.count == 1 {
    print("You have chosen this challenge, \(committedChallenges[0])")
}
else {
