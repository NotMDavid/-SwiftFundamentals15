...
case 161...180:
    print("You are in the Hard zone. Acitvity in this zone increase maximum performace capacity for shorter sessions.")
case 181...200:
    print("You are in the Maximum zone. Activitiy in this zone helps fit athletes develop speed")
default:
    print("Warning, slow down on your HR.")
}
