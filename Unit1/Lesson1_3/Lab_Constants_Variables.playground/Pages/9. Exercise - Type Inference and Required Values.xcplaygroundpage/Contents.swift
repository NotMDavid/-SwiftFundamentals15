...
var name: String
print(name)
print("It doesn't because there is nothing to show")
...
var distanceTraveled: Double = 0 // Changed
...
print("It can't because our value here is a double, meanwhile we set it as a double value.")
print("TO fix this, we need to set the distanceTraveled as A DOUBLE.")
